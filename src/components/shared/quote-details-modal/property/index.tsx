...
import { PROPERTY_QUOTE_BY_ID } from "@/lib/sektor-api/queries";
...
import { PropertyQuoteType, Query } from "@/lib/sektor-api/__generated__/types";
...
const PropertyQuoteDetails = () => {
  ...
  const {
    ...
    error,
    loading: isLoading,
  } = useQuery<Query>(PROPERTY_QUOTE_BY_ID, {
    variables: { id: quoteId },
    fetchPolicy: "no-cache",
  });

  const quoteData = data?.propertyQuoteById as PropertyQuoteType;
        ...
        <div className="w-full flex flex-col items-center justify-center gap-5 ">
          ...
          <div className="w-full grid grid-cols-1 gap-6 md:grid-cols-2 !cursor-default hover:!cursor-default">
            <SwitchInput
              ...
              disabled={true}
              icon={faPeopleRoof}
              wrapperClassName="hover:!select-none"
              switchProps={{
                checked: industryAndCommerce,
                className:
...
export default PropertyQuoteDetails;
